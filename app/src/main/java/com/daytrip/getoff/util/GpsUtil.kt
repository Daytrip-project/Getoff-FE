        ...
        locationCallback = object : LocationCallback() {
            override fun onLocationResult(p0: LocationResult) {
                ...
                for (location in p0.locations) {
                    ...
                    val intent = Intent("com.daytrip.UPDATE_LOCATION")
...
//                bus_stop_list: ArrayList<BusStop>? = intent.getParcelableExtra("bus_stop_list", ArrayList<BusStop>?)
        ...
        notificationReceiver = object : BroadcastReceiver() {
            override fun onReceive(context: android.content.Context, intent: android.content.Intent) {
                if (intent.action == "com.daytrip.CANCEL_ARRIVE_ALARM") {
                    resetDestination()
                }
                if (intent.action == "com.daytrip.CANCEL_SUGGEST_ALARM") {
                    notificationManager.cancel(SUGGEST_ALARM_NOTIFICATION_ID)
                }
                if (intent.action == "com.daytrip.CANCEL_GPS_ALARM") {
                    stopForeground(true)
        ...
        registerReceiver(destinationReceiver, IntentFilter("com.daytrip.UPDATE_DESTINATION"))
        val filter = IntentFilter().apply {
            addAction("com.daytrip.CANCEL_SUGGEST_ALARM")
            addAction("com.daytrip.CANCEL_ARRIVE_ALARM")
            addAction("com.daytrip.CANCEL_GPS_ALARM")
        }
...
//        )
        ...
        val actionIntent = Intent("com.daytrip.CANCEL_GPS_ALARM")
...
//        )
        ...
        val actionIntent = Intent("com.daytrip.CANCEL_SUGGEST_ALARM")
...
//        notificationManager.notify(SUGGEST_ALARM_NOTIFICATION_ID, notification)
    ...
    private fun manageAlarmNotification() {
        val actionIntent = Intent("com.daytrip.CANCEL_ARRIVE_ALARM")
